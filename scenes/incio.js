...
export default class incio extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(width / 2, height / 2 - 150, "beta")
      .setOrigin(0.5)
    ...
    this.add.text(width / 2, height / 2 - 80, "¡Escapa de la red y elimina los plasticos!", {
    ...
    this.add.image(width / 2, height / 2 + 140, "FLECHAS")
      .setOrigin(0.5)
      .setDisplaySize(width / 4, height / 4)
      .setTint(0x303030); // Aplicar color blanco

    // Instrucciones para jugar
    this.add.text(width / 2, height / 2 + 300, "Presiona I para iniciar", {
      fontFamily: "PixelFont",
      fontSize: "40px",
      fill: "#00cfff",
      stroke: "#505050", // Contorno gris
